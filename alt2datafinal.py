...
df = pandas.read_csv('alt2data3.csv')
timestudy = df['Time Studying']
median_value = statistics.median(timestudy)
print('median of hours studying:',median_value)
print('\n')

df = pandas.read_csv('alt2data3.csv')
phonetime = df['Phone']
median_value = statistics.median(phonetime)
print('median of hours on phone:',median_value)
print('\n')

df = pandas.read_csv('alt2data3.csv')
mondayhr = df['Monday']
median_value = statistics.median(mondayhr)
print('median of hours Monday:',median_value)
print('\n')

df = pandas.read_csv('alt2data3.csv')
tuesdayhr = df['Tuesday']
median_value = statistics.median(tuesdayhr)
print('median of hours Tuesday:',median_value)
print('\n')

df = pandas.read_csv('alt2data3.csv')
wednesdayhr = df['Wednesday']
median_value = statistics.median(wednesdayhr)
print('median of hours Wednesday:',median_value)
print('\n')

df = pandas.read_csv('alt2data3.csv')
thursdayhr = df['Thursday']
median_value = statistics.median(thursdayhr)
print('median of hours Thursday:',median_value)
print('\n')
